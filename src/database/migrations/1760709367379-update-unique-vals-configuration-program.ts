...
export class UpdateUniqueValsConfigurationProgram1760709367379 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "programs" DROP CONSTRAINT "UQ_ba50d0f7b68ee5b73f7e7b8fdf9"`);
        await queryRunner.query(`ALTER TABLE "workflows" DROP CONSTRAINT "UQ_a911fb2e0cb9ea97b6c39e0708c"`);
